class Student :
    def __init__(self, rollno, name, branch, section):
        self._rollno = rollno
        self._name = name 
        self._branch = branch 
...
class Marks(Student):
    def __init__(self,rollno, name, branch, section, m1, m2, m3):
        super().__init__(rollno, name, branch, section)
        self._m1 = m1 
        self._m2 = m2 
        self._m3 = m3 
...
class MarksReport(Marks):
    def __init__(self, rollno, name, branch, section, m1, m2, m3):
        super().__init__(rollno, name, branch, section, m1, m2, m3)
...
a = MarksReport(rollno, name, branch, section, m1, m2, m3)
